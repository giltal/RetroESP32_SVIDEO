#!/usr/bin/env python
# Flash + (optional) monitor for RetroESP32_Atari.
#
...
BUILD   = r'C:\ESPIDFprojects\RetroESP32_Atari\build'
...
flash_cmd = [
    ...
    '0x10000', BUILD + r'\RetroESP32_Atari.bin',
]

print('Flashing RetroESP32_Atari to', PORT, '...')
