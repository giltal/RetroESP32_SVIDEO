...
#include <stdlib.h>
#include <string.h>
/* ESP-IDF: removed #include <Arduino.h> */
...
#include "statesav.h"
#endif
/* ESP-IDF: removed ESP32_S3_8P_GameConsole.h (Arduino project header not needed) */
...
UBYTE MEMORY_HwGetByte(UWORD addr, int no_side_effects)
{
	...
	case 0xd700:				/* PBI page D7 */
		...
		break;
	case 0xD010: /* POT button - handled via standard input on Odroid Go */
		byte = 1; /* not pressed */
		break;
	default:
		break;
