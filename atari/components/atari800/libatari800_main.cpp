...
/* Frame skip flag — set by main.cpp to skip ANTIC screen rendering
   on alternate frames for performance.  ANTIC DMA + CPU timing still run. */
extern int atari800_draw_frame;
...
void LIBATARI800_Frame(void)
{
	...
	INPUT_Frame();
	GTIA_Frame();
	ANTIC_Frame(atari800_draw_frame);
