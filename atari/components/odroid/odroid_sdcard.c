...
// SD-SPI pins for THIS board (from the original sketch: SDspi.begin(15,18,13,4)
// = sck,miso,mosi,ss). The odroid-go defaults (19/23/18/22) collided with the
// CH559 UART (19/23) and the UP button (22) - do NOT use those here.
#define SD_PIN_NUM_CLK  15
#define SD_PIN_NUM_MISO 18
