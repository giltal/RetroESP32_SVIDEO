#!/usr/bin/env python
# Flash + (optional) monitor for RetroESP32_SVIDEO.
#
...
BUILD   = r'C:\ESPIDFprojects\RetroESP32_SVIDEO\build'
ATARI   = r'C:\ESPIDFprojects\RetroESP32_Atari\build\RetroESP32_Atari.bin'   # ota_0 @ 0x1C0000
GB      = r'C:\ESPIDFprojects\RetroESP32_GB\build\RetroESP32_GB.bin'         # ota_1 @ 0x2E0000
...
flash_cmd = [
    ...
    '0x1b0000', BUILD + r'\ota_data_initial.bin',   # otadata: boot factory (launcher) by default
    '0x10000',  BUILD + r'\RetroESP32_SVIDEO.bin',
]
# Also flash the Atari OTA app into ota_0 (0x1C0000) when it's been built.
if os.path.exists(ATARI):
    flash_cmd += ['0x1C0000', ATARI]
    print('(including Atari OTA app -> ota_0 @ 0x1C0000)')
# Also flash the GB/GBC OTA app into ota_1 (0x2E0000) when it's been built.
if os.path.exists(GB):
    flash_cmd += ['0x2E0000', GB]
    print('(including GB/GBC OTA app -> ota_1 @ 0x2E0000)')

print('Flashing RetroESP32_SVIDEO to', PORT, '...')
